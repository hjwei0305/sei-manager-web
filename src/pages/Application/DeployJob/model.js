...
import { delParentRow, saveParent, saveChild, delChildRow, creatJenkinsJob } from './service';
...
export default modelExtend(model, {
  ...
  effects: {
    ...
    *creatJenkinsJob({ payload }, { call }) {
      const result = yield call(creatJenkinsJob, payload);
      const { success, message: msg } = result || {};
      if (success) {
        message.success(msg);
      } else {
