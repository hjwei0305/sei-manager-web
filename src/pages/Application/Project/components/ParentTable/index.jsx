...
class CascadeTableMaster extends Component {
  ...
  renderDelBtn = row => {
    ...
    if (loading.effects['project/delPRow'] && delRowId === row.id) {
  ...
  getFormModalProps = () => {
    ...
    const { pVisible, currPRowData, isAddP } = project;
    ...
    return {
      ...
      isSaving: loading.effects['project/saveParent'],
    };
  };
