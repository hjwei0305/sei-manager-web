...
import { del, editSave, createSave } from '../services/applyModule';
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        if (pathMatchRegexp('/my-center/apply/applicationModule/new', location.pathname)) {
          dispatch({
            type: 'updateState',
            payload: {
              rowData: null,
